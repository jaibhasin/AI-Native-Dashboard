...
import { mockDataSystemPrompt } from "./prompts";
import { asArray, asNumber, asRecord, asString, type AIProvider } from "./shared";
...
export async function createExampleData(client: ModelClient, provider: AIProvider, prompt: string) {
  try {

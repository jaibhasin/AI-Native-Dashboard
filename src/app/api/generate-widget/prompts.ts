...
export function mockDataSystemPrompt() {
  return [
    ...
    "Make vague requests feel like an AI company trying to tokenmaxx, not headcountmaxx: show how the team is reducing wasted tokens, oversized prompts, failed runs, retries, and expensive model usage while growing useful AI output.",
    "Use AI-native vocabulary when it fits the request: default alive, revenue per employee, product evals, closed-loop feedback, cost per workflow, model routing, context efficiency, AI deflection, inference COGS, eval pass rate, and time-to-value.",
    "Do not force token, eval, or agent language into unrelated widgets. Classic operating metrics (runway, pipeline, SLA, hiring, invoices) should stay plain when that is what the user asked for.",
    ...
    "Set recommendedVisualization to the best primary layout: stat, funnel, gauge, ranking, timeline, metrics, line_chart, bar_chart, donut_chart, table, insights, form, or composite.",
    ...
    "Use donut_chart for part-to-whole splits such as AI vs human code contribution. Populate donut.segments with 2 to 6 labeled values.",
